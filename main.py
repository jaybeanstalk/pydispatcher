...
parser.add_argument("nation", help="Iterate through the directory associated with this nation, and use each file to post or edit a dispatch.")
parser.add_argument("--config", help="Specify a configuration (.ini) file in a location other than in the same directory as this program")
